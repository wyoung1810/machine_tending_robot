...
static const _SpawnEntity_Request_type_support_symbol_names_t _SpawnEntity_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, SpawnEntity_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ign_interfaces, srv, SpawnEntity_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_ign_interfaces, srv, SpawnEntity_Request)() {
  return &::ros_ign_interfaces::srv::rosidl_typesupport_c::SpawnEntity_Request_message_type_support_handle;
}
...
static const _SpawnEntity_Response_type_support_symbol_names_t _SpawnEntity_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, SpawnEntity_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ign_interfaces, srv, SpawnEntity_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_ign_interfaces, srv, SpawnEntity_Response)() {
  return &::ros_ign_interfaces::srv::rosidl_typesupport_c::SpawnEntity_Response_message_type_support_handle;
}
...
static const _SpawnEntity_type_support_symbol_names_t _SpawnEntity_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, SpawnEntity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ign_interfaces, srv, SpawnEntity)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros_ign_interfaces, srv, SpawnEntity)() {
  return &::ros_ign_interfaces::srv::rosidl_typesupport_c::SpawnEntity_service_type_support_handle;
}
