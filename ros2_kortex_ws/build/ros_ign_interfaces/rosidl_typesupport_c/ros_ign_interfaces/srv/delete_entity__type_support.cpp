...
static const _DeleteEntity_Request_type_support_symbol_names_t _DeleteEntity_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, DeleteEntity_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ign_interfaces, srv, DeleteEntity_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_ign_interfaces, srv, DeleteEntity_Request)() {
  return &::ros_ign_interfaces::srv::rosidl_typesupport_c::DeleteEntity_Request_message_type_support_handle;
}
...
static const _DeleteEntity_Response_type_support_symbol_names_t _DeleteEntity_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, DeleteEntity_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ign_interfaces, srv, DeleteEntity_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_ign_interfaces, srv, DeleteEntity_Response)() {
  return &::ros_ign_interfaces::srv::rosidl_typesupport_c::DeleteEntity_Response_message_type_support_handle;
}
...
static const _DeleteEntity_type_support_symbol_names_t _DeleteEntity_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, DeleteEntity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ign_interfaces, srv, DeleteEntity)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros_ign_interfaces, srv, DeleteEntity)() {
  return &::ros_ign_interfaces::srv::rosidl_typesupport_c::DeleteEntity_service_type_support_handle;
}
