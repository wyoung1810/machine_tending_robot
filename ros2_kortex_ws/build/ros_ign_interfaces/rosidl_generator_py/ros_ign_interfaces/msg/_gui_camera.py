...
class Metaclass_GuiCamera(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_ign_interfaces.msg import TrackVisual
...
class GuiCamera(metaclass=Metaclass_GuiCamera):
    ...
    _fields_and_field_types = {
        ...
        'track': 'ros_ign_interfaces/TrackVisual',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['ros_ign_interfaces', 'msg'], 'TrackVisual'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
    )
