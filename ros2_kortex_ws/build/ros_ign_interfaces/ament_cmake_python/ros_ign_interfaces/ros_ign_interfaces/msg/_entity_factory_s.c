...
bool ros_ign_interfaces__msg__entity_factory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_ign_interfaces.msg._entity_factory.EntityFactory", full_classname_dest, 52) == 0);
  }
  ros_ign_interfaces__msg__EntityFactory * ros_message = _ros_message;
  {  // name
...
PyObject * ros_ign_interfaces__msg__entity_factory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_ign_interfaces.msg._entity_factory");
