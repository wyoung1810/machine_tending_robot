...
#ifndef ROS_IGN_INTERFACES__MSG__DETAIL__TRACK_VISUAL__STRUCT_HPP_
#define ROS_IGN_INTERFACES__MSG__DETAIL__TRACK_VISUAL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ros_ign_interfaces__msg__TrackVisual __attribute__((deprecated))
#else
# define DEPRECATED__ros_ign_interfaces__msg__TrackVisual __declspec(deprecated)
#endif
...
struct TrackVisual_
{
  ...
  using ConstRawPtr =
    const ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ros_ign_interfaces__msg__TrackVisual
    std::shared_ptr<ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros_ign_interfaces__msg__TrackVisual
    std::shared_ptr<ros_ign_interfaces::msg::TrackVisual_<ContainerAllocator> const>
...
using TrackVisual =
  ros_ign_interfaces::msg::TrackVisual_<std::allocator<void>>;
...
#endif  // ROS_IGN_INTERFACES__MSG__DETAIL__TRACK_VISUAL__STRUCT_HPP_
