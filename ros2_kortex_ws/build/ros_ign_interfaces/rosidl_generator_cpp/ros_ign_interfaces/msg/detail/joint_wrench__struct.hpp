...
#ifndef ROS_IGN_INTERFACES__MSG__DETAIL__JOINT_WRENCH__STRUCT_HPP_
#define ROS_IGN_INTERFACES__MSG__DETAIL__JOINT_WRENCH__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ros_ign_interfaces__msg__JointWrench __attribute__((deprecated))
#else
# define DEPRECATED__ros_ign_interfaces__msg__JointWrench __declspec(deprecated)
#endif
...
struct JointWrench_
{
  ...
  // pointer types
  using RawPtr =
    ros_ign_interfaces::msg::JointWrench_<ContainerAllocator> *;
  using ConstRawPtr =
    const ros_ign_interfaces::msg::JointWrench_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ros_ign_interfaces::msg::JointWrench_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ros_ign_interfaces::msg::JointWrench_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ros_ign_interfaces::msg::JointWrench_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ros_ign_interfaces::msg::JointWrench_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ros_ign_interfaces::msg::JointWrench_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ros_ign_interfaces::msg::JointWrench_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ros_ign_interfaces::msg::JointWrench_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ros_ign_interfaces__msg__JointWrench
    std::shared_ptr<ros_ign_interfaces::msg::JointWrench_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros_ign_interfaces__msg__JointWrench
    std::shared_ptr<ros_ign_interfaces::msg::JointWrench_<ContainerAllocator> const>
...
using JointWrench =
  ros_ign_interfaces::msg::JointWrench_<std::allocator<void>>;
...
#endif  // ROS_IGN_INTERFACES__MSG__DETAIL__JOINT_WRENCH__STRUCT_HPP_
