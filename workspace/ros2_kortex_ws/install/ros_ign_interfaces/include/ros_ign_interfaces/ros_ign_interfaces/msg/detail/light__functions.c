...
ros_ign_interfaces__msg__Light__init(ros_ign_interfaces__msg__Light * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ros_ign_interfaces__msg__Light__fini(msg);
    return false;
  }
  // name
...
ros_ign_interfaces__msg__Light__create()
{
  ...
  ros_ign_interfaces__msg__Light * msg = (ros_ign_interfaces__msg__Light *)allocator.allocate(sizeof(ros_ign_interfaces__msg__Light), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros_ign_interfaces__msg__Light));
  bool success = ros_ign_interfaces__msg__Light__init(msg);
  if (!success) {
...
ros_ign_interfaces__msg__Light__Sequence__init(ros_ign_interfaces__msg__Light__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_ign_interfaces__msg__Light * data = NULL;

  if (size) {
    data = (ros_ign_interfaces__msg__Light *)allocator.zero_allocate(size, sizeof(ros_ign_interfaces__msg__Light), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros_ign_interfaces__msg__Light__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros_ign_interfaces__msg__Light__fini(&data[i - 1]);
      }
...
ros_ign_interfaces__msg__Light__Sequence__fini(ros_ign_interfaces__msg__Light__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros_ign_interfaces__msg__Light__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_ign_interfaces__msg__Light__Sequence * array = (ros_ign_interfaces__msg__Light__Sequence *)allocator.allocate(sizeof(ros_ign_interfaces__msg__Light__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros_ign_interfaces__msg__Light__Sequence__init(array, size);
  if (!success) {
...
ros_ign_interfaces__msg__Light__Sequence__destroy(ros_ign_interfaces__msg__Light__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros_ign_interfaces__msg__Light__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros_ign_interfaces__msg__Light__Sequence__are_equal(const ros_ign_interfaces__msg__Light__Sequence * lhs, const ros_ign_interfaces__msg__Light__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros_ign_interfaces__msg__Light__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros_ign_interfaces__msg__Light__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros_ign_interfaces__msg__Light);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros_ign_interfaces__msg__Light * data =
      (ros_ign_interfaces__msg__Light *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_ign_interfaces__msg__Light__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_ign_interfaces__msg__Light__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros_ign_interfaces__msg__Light__copy(
