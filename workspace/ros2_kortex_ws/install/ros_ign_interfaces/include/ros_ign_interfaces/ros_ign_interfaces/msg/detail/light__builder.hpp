...
#ifndef ROS_IGN_INTERFACES__MSG__DETAIL__LIGHT__BUILDER_HPP_
#define ROS_IGN_INTERFACES__MSG__DETAIL__LIGHT__BUILDER_HPP_
...
{
public:
  explicit Init_Light_name(::ros_ign_interfaces::msg::Light & msg)
  : msg_(msg)
  {}
...
public:
  ...
  {}
  Init_Light_name header(::ros_ign_interfaces::msg::Light::_header_type arg)
  {
...
{
  return ros_ign_interfaces::msg::builder::Init_Light_header();
}

}  // namespace ros_ign_interfaces

#endif  // ROS_IGN_INTERFACES__MSG__DETAIL__LIGHT__BUILDER_HPP_
