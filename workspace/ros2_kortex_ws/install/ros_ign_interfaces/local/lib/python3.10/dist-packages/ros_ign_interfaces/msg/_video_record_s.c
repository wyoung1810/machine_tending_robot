...
bool ros_ign_interfaces__msg__video_record__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_ign_interfaces.msg._video_record.VideoRecord", full_classname_dest, 48) == 0);
  }
  ros_ign_interfaces__msg__VideoRecord * ros_message = _ros_message;
  {  // header
...
PyObject * ros_ign_interfaces__msg__video_record__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_ign_interfaces.msg._video_record");
