...
static const _SingleDOFState_type_support_symbol_names_t _SingleDOFState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_msgs, msg, SingleDOFState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_msgs, msg, SingleDOFState)),
  }
};
...
{
  return &::control_msgs::msg::rosidl_typesupport_cpp::SingleDOFState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, control_msgs, msg, SingleDOFState)() {
  return get_message_type_support_handle<control_msgs::msg::SingleDOFState>();
}
