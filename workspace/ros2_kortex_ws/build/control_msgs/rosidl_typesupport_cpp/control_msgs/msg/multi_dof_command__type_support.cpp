...
static const _MultiDOFCommand_type_support_symbol_names_t _MultiDOFCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_msgs, msg, MultiDOFCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_msgs, msg, MultiDOFCommand)),
  }
};
...
{
  return &::control_msgs::msg::rosidl_typesupport_cpp::MultiDOFCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, control_msgs, msg, MultiDOFCommand)() {
  return get_message_type_support_handle<control_msgs::msg::MultiDOFCommand>();
}
