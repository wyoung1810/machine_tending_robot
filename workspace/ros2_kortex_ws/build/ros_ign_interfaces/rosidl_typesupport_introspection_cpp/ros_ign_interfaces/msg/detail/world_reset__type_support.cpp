...
{
  new (message_memory) ros_ign_interfaces::msg::WorldReset(_init);
}

void WorldReset_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_ign_interfaces::msg::WorldReset *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WorldReset_message_member_array[3] = {
  {
    ...
    offsetof(ros_ign_interfaces::msg::WorldReset, all),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_ign_interfaces::msg::WorldReset, time_only),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_ign_interfaces::msg::WorldReset, model_only),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WorldReset_message_members = {
  ...
  3,  // number of fields
  sizeof(ros_ign_interfaces::msg::WorldReset),
...
{
  return &::ros_ign_interfaces::msg::rosidl_typesupport_introspection_cpp::WorldReset_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_ign_interfaces, msg, WorldReset)() {
  return &::ros_ign_interfaces::msg::rosidl_typesupport_introspection_cpp::WorldReset_message_type_support_handle;
}
