...
static const _ControlWorld_Request_type_support_symbol_names_t _ControlWorld_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, ControlWorld_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ign_interfaces, srv, ControlWorld_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_ign_interfaces, srv, ControlWorld_Request)() {
  return &::ros_ign_interfaces::srv::rosidl_typesupport_c::ControlWorld_Request_message_type_support_handle;
}
...
static const _ControlWorld_Response_type_support_symbol_names_t _ControlWorld_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, ControlWorld_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ign_interfaces, srv, ControlWorld_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_ign_interfaces, srv, ControlWorld_Response)() {
  return &::ros_ign_interfaces::srv::rosidl_typesupport_c::ControlWorld_Response_message_type_support_handle;
}
...
static const _ControlWorld_type_support_symbol_names_t _ControlWorld_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, ControlWorld)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ign_interfaces, srv, ControlWorld)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros_ign_interfaces, srv, ControlWorld)() {
  return &::ros_ign_interfaces::srv::rosidl_typesupport_c::ControlWorld_service_type_support_handle;
}
